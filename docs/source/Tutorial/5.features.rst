...
.. video:: img/phenomenon/police_mode.mp4
    :width: 100%
...
.. video:: img/phenomenon/relays.mp4
    :width: 100%
...
**Smart Features**
* Supports voice-driven status checks after the device is connected and bound
* Can be extended through firmware and backend customization for advanced automation
